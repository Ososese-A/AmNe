...
class _TransactionBoxState extends State<TransactionBox> {
  ...
  Widget build(BuildContext context) {
    bool isTransactionHistoryEmpty = Provider.of<HistoryModel>(context).isTransactionHistoryEmpty;
    ...
    typedTransactionHistory.sort((a, b) => b['dateTime'].compareTo(a['dateTime']));
